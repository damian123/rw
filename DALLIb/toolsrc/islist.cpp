 ...
 *
 * $Id: islist.cpp,v 6.3 1994/07/18 20:51:00 jims Exp $
 *
 ****************************************************************************
 *
...
RW_RCSID("Copyright (C) Rogue Wave Software --- $RCSfile: islist.cpp,v $ $Revision: 6.3 $ $Date: 1994/07/18 20:51:00 $");
...
{
  RWPRECONDITION2(a!=rwnil, "RWIsvSlist::RWIsvSlist(RWIsvSlink*): Attempt to construct with nil pointer");
...
{
  RWPRECONDITION2(a!=rwnil, "RWIsvSlist::containsReference(const RWISvSlink*): nil pointer");
...
{
  RWPRECONDITION2(a!=rwnil, "RWIsvSlist::insertAt(size_t,RWIsvSlink*): nil pointer");
...
{
  RWPRECONDITION2(prev!=rwnil, "RWIsvSlist::removeRight(RWIsvSlink*): Internal error");

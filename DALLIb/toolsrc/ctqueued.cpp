/*
 * $Id: ctqueued.cpp,v 6.3 1994/07/18 20:51:00 jims Exp $
 *
 ****************************************************************************
 *
 ...
 * Updated Copyright
 *
 * Revision 6.1  1994/04/15  19:06:14  vriezen
 * Move all files to 6.1
 *
 * Revision 2.3  1994/03/09  01:03:36  jims
 * No longer qualify call to operator==
 *
...
RW_RCSID("Copyright (C) Rogue Wave Software --- $RCSfile: ctqueued.cpp,v $ $Revision: 6.3 $ $Date: 1994/07/18 20:51:00 $");

RWBoolean
RWSlistCollectablesQueue::isEqual(const RWCollectable* c) const
{
  if( c->isA() != __RWSLISTCOLLECTABLESQUEUE ) return FALSE;
  return operator==(*(const RWSlistCollectablesQueue*)c);
}

#ifndef __RW_TOGGLE_BUTTON_GADGET_H
#define __RW_TOGGLE_BUTTON_GADGET_H
/*********************************************************************
*
*  $Id: ToggleBG.h,v 1.11 1993/10/07 01:42:57 keffer Exp $
*
...
/*********************************************************************
* RWToggleButtonGadget : Class object which represents the
* XmToggleButtonGadget widget in the OSF/Motif widget set.
*********************************************************************/

class RWToggleButtonGadget : public RWLabelGadget
{
 public:
  RWToggleButtonGadget
    (
    RWController *,
    const RWCString &,
...
// RW TOOLS MEMBER FUNCTIONS
  virtual RWClassID isA () const {return __RWTOGGLEBUTTONGADGET;}
  
 private:
  RWCallback * getCallbackObject (RWXtPointer);
};

#endif  /* End of file ToggleBG.h - Do not add beyond this point! */

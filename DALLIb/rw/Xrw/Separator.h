#ifndef __RW_SEPARATOR_H
#define __RW_SEPARATOR_H
/*********************************************************************
*
*  $Id: Separator.h,v 1.8 1993/10/07 01:42:57 keffer Exp $
*
...
/*********************************************************************
* RWSeparator : Class object which represents the XmSeparator
* widget in the OSF/Motif widget set.
*********************************************************************/

class RWSeparator : public RWPrimitive
{
 public:
  RWSeparator
    (
...
// RW TOOLS MEMBER FUNCTIONS
  virtual RWClassID isA () const {return __RWSEPARATOR;}
};

#endif  /* End of file Separator.h - Do not add beyond this point! */

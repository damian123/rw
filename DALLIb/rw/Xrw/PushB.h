#ifndef __RW_PUSH_BUTTON_H
#define __RW_PUSH_BUTTON_H
/*********************************************************************
*
*  $Id: PushB.h,v 1.12 1993/10/07 01:42:57 keffer Exp $
*
...
/*********************************************************************
* RWPushButton : Class object which represents the XmPushButton
* widget in the OSF/Motif widget set.
*********************************************************************/

class RWPushButton : public RWLabel {
public:
  RWPushButton
    (
    RWController *,
...
// RW TOOLS MEMBER FUNCTIONS
  virtual RWClassID isA () const {return __RWPUSHBUTTON;}  
  
private:
  RWCallback * getCallbackObject (RWXtPointer);
};

#endif  /* End of file PushB.h - Do not add beyond this point! */

...
/*********************************************************************
*
*  $Id: Custom.h,v 1.11 1994/01/10 23:52:01 cynthia Exp $
*
...
*                from which application-specific custom dialogs should be
*                derived
*
*
*  Revision History:
...
class RWCustomDialog : public RWDialogView {

 public:
  RWCustomDialog (RWView        *parentView, 
		  const char    *name    = "RWCustomDialog",
		  RWButtonConfig buttons = RWOkCancelButton,
		  RWBoolean      hasMenu = FALSE);
  virtual ~RWCustomDialog();
  ...
  virtual RWClassID isA() const { return(__RWCUSTOMDIALOG); }

protected:
#ifdef RWVIEW1_COMPATIBLE
  void removeDialogControls() { hideDialogControls(); }
#endif

#ifndef __RW_LABEL_GADGET_H
#define __RW_LABEL_GADGET_H
/*********************************************************************
*
*  $Id: LabelG.h,v 1.10 1993/10/07 01:42:57 keffer Exp $
*
...
/*********************************************************************
* RWLabelGadget : Class object which represents the XmLabelGadget
* widget in the OSF/Motif widget set.
*********************************************************************/

class RWLabelGadget : public RWGadget {
public:
  RWLabelGadget
    (
    RWController *, 
...
// RESOURCE MEMBER FUNCTIONS
  ...
  RWCString             getAcceleratorC           (RWCString *val = 0);
...
// RW TOOLS MEMBER FUNCTIONS
  virtual RWClassID isA () const {return __RWLABELGADGET;}
  
 private:
};

#endif  /* End of file LabelG.h - Do not add beyond this point! */

...
// For errors involving vstreams:
class RWExport RWVstreamErr : public RWExternalErr
{

public:

  RWVstreamErr(const char*     , RWios&);
  RWVstreamErr(const RWMessage&, RWios&);

  RWios&    errStream()          { return stream_; }

/*
 * Implementation of RWSymSomeEigServer and RWSymRangeEigServer
 *
 * $Id: //lapack/13/rw/lapack/seigbis.cc#1 $
 *
...
RWSymSomeEigServer<TypeT>::RWSymSomeEigServer(bool computeVecs)
...
template <class TypeT>
TypeT RWSymSomeEigServer<TypeT>::setTolerance(TypeT t)
{
    TypeT temp = tolerance_;
    tolerance_ = t;
    return temp;
}

template <class TypeT>
RWSlice RWSymSomeEigServer<TypeT>::setRange(const RWSlice& x)
{
    RWSlice temp = range;
    range = x;
    return temp;
...
template <class TypeT>
bool RWSymSomeEigServer<TypeT>::computeEigenVectors() const
{
    return computeVecs_;
}

template <class TypeT>
void              RWSymSomeEigServer<TypeT>::computeEigenVectors(bool x)
{
    computeVecs_ = x;
}

template <class TypeT>
RWSymEigDecomp<TypeT>   RWSymSomeEigServer<TypeT>::decompose(const RWTriDiagDecomp<TypeT>& decomp)
{
...
/********************************************
 * Implementation of RWSymRangeEigServer *
 ********************************************/

template <class TypeT>
RWSymRangeEigServer<TypeT>::RWSymRangeEigServer(bool computeVecs)
{
    computeVecs_ = computeVecs;
    tolerance_ = 0;
    small_ = -DBL_MAX;
...
template <>
inline RWSymRangeEigServer<float>::RWSymRangeEigServer(bool computeVecs)
{
    computeVecs_ = computeVecs;
    tolerance_ = 0;
    small_ = -FLT_MAX;
...
template <class TypeT>
void              RWSymRangeEigServer<TypeT>::setRange(TypeT x, TypeT y)
{
    small_ = x;
    large_ = y;
}
...
template <class TypeT>
TypeT            RWSymRangeEigServer<TypeT>::setSmall(TypeT x)
{
    TypeT temp = small_;
    small_ = x;
    return temp;
...
template <class TypeT>
TypeT            RWSymRangeEigServer<TypeT>::setLarge(TypeT x)
{
    TypeT temp = large_;
    large_ = x;
    return temp;
...
template <class TypeT>
TypeT            RWSymRangeEigServer<TypeT>::setTolerance(TypeT t)
{
    TypeT temp = tolerance_;
    tolerance_ = t;
    return temp;
...
template <class TypeT>
bool RWSymRangeEigServer<TypeT>::computeEigenVectors() const
{
    return computeVecs_;
}

template <class TypeT>
void              RWSymRangeEigServer<TypeT>::computeEigenVectors(bool x)
{
    computeVecs_ = x;
}

template <class TypeT>
RWSymEigDecomp<TypeT>   RWSymRangeEigServer<TypeT>::decompose(const RWTriDiagDecomp<TypeT>& decomp)
{
    RWSymEigDecomp<TypeT> eig;
    RWSymEigServer<TypeT>::n(eig) = decomp.rows();

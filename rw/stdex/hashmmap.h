#ifndef RW_TOOLS_STDEX_HASHMMAP_H_
#define RW_TOOLS_STDEX_HASHMMAP_H_


/**********************************************************************
 *
 * $Id: //tools/13/rw/stdex/hashmmap.h#5 $
 *
 **********************************************************************
 *
 ...
 * where multiple instances of the same \c K are allowed.
 *
 * Class rw_hashmultimap maintains a collection mapping between instances of
 * \c K (the key) and \c V (the value), implemented as a hash table of
 * \b std::pair<const K,V> in which there may be more than one instance of
 * any given \c K. Since this is a \e value-based collection, objects are
 * \e copied into and out of the collection. As with all classes that meet
 * the ANSI <i>associative container</i> specification, rw_hashmultimap
 * provides for iterators that reference its elements. Since the contents of
...
public:
     ...
     */
    typedef rw_hashtable<std::pair<const K, V>, Hash, EQ, A, rw_allow_duplicates, rw_pair_based_key> impl_type;
     ...
     * \link rw_hashmultimap::hasher hasher \endlink instead.
     *
     * A type representing the hash function.
     */
    typedef typename impl_type::hasher
    RW_DEPRECATE_TYPE("Use rw_hashmultimap::hasher instead") key_hash_type;
#endif
...
public:
    /**
     * Constructs an empty rw_hashmultimap with \a cap buckets, using \a h
     ...
     * of buckets is used.
     */
    rw_hashmultimap(size_type cap = RW_DEFAULT_CAPACITY,
                    const hasher& h = hasher(),
                    const key_equal_type& eq = key_equal_type());

    /**
     * Constructs an rw_hashmultimap that is a copy of \a other. Each
     * element from \a other is copied into self.
     */
    rw_hashmultimap(const rw_hashmultimap& other);

#if !defined(RW_NO_RVALUE_REFERENCES)
    /**
     * Move constructor. The constructed rw_hashmultimap takes ownership of
     ...
     * support.
     */
    rw_hashmultimap(rw_hashmultimap && other);
#endif // !RW_NO_RVALUE_REFERENCES

    /**
     * Constructs an rw_hashmultimap containing a copy of the pair elements
     * in the range [\a first, \a last). The rw_hashmultimap instance has
     * \a cap buckets, uses \a h as its hash function object, and \a eq as
     * its equality function object.
     *
    ...
    rw_hashmultimap(InputIterator first, InputIterator last,
     ...
     */
    rw_hashmultimap& operator=(const rw_hashmultimap& rhs);
     ...
     * support.
     */
    rw_hashmultimap& operator=(rw_hashmultimap && rhs);
#endif // !RW_NO_RVALUE_REFERENCES
     ...
     */
    bool
    equal_by_keys(const rw_hashmultimap& rhs) const;
...
private:
    ...
    friend bool operator==(const rw_hashmultimap<K1, V1, H1, E1, A1>& lhs,
                           const rw_hashmultimap<K1, V1, H1, E1, A1>& rhs);
...
inline
typename rw_hashmultimap<K, V, Hash, EQ, A>::hasher
rw_hashmultimap<K, V, Hash, EQ, A>::key_hash() const
{
...
template <class K, class V, class Hash, class EQ, class A>
inline
typename rw_hashmultimap<K, V, Hash, EQ, A>::key_equal_type
rw_hashmultimap<K, V, Hash, EQ, A>::key_equal() const
{
    return impl_.key_eq();
}
...
template <class K, class V, class Hash, class EQ, class A>
inline
typename rw_hashmultimap<K, V, Hash, EQ, A>::value_hash_type
rw_hashmultimap<K, V, Hash, EQ, A>::value_hash() const
{
...
template <class K, class V, class Hash, class EQ, class A>
inline
typename rw_hashmultimap<K, V, Hash, EQ, A>::value_equal_type
rw_hashmultimap<K, V, Hash, EQ, A>::value_equal() const
{
...
template <class K, class V, class Hash, class EQ, class A>
inline
rw_hashmultimap<K, V, Hash, EQ, A>::rw_hashmultimap(size_type cap,
        const hasher& h,
...
template <class K, class V, class Hash, class EQ, class A>
inline
rw_hashmultimap<K, V, Hash, EQ, A>::rw_hashmultimap(const rw_hashmultimap& other)
    : impl_(other.impl_)
{
}
...
template <class K, class V, class Hash, class EQ, class A>
inline
rw_hashmultimap<K, V, Hash, EQ, A>::rw_hashmultimap(rw_hashmultimap && other)
...
template <class K, class V, class Hash, class EQ, class A>
inline
rw_hashmultimap<K, V, Hash, EQ, A>&
rw_hashmultimap<K, V, Hash, EQ, A>::operator=(const rw_hashmultimap& rhs)
{
    if (&rhs != this) {
        impl_ = rhs.impl_;
    }
...
inline
rw_hashmultimap<K, V, Hash, EQ, A>&
rw_hashmultimap<K, V, Hash, EQ, A>::operator=(rw_hashmultimap && rhs)
{
    if (&rhs != this) {
...
template <class K, class V, class Hash, class EQ, class A>
inline
typename rw_hashmultimap<K, V, Hash, EQ, A>::iterator
rw_hashmultimap<K, V, Hash, EQ, A>::begin()
{
    return impl_.begin();
}
...
template <class K, class V, class Hash, class EQ, class A>
inline
typename rw_hashmultimap<K, V, Hash, EQ, A>::const_iterator
rw_hashmultimap<K, V, Hash, EQ, A>::begin() const
{
    return impl_.begin();
}
...
inline
typename rw_hashmultimap<K, V, Hash, EQ, A>::const_iterator
rw_hashmultimap<K, V, Hash, EQ, A>::cbegin() const
{
    return impl_.cbegin();
}
...
inline
typename rw_hashmultimap<K, V, Hash, EQ, A>::iterator
rw_hashmultimap<K, V, Hash, EQ, A>::end()
{
    return impl_.end();
}
...
inline
typename rw_hashmultimap<K, V, Hash, EQ, A>::const_iterator
rw_hashmultimap<K, V, Hash, EQ, A>::end() const
{
    return impl_.end();
}
...
inline
typename rw_hashmultimap<K, V, Hash, EQ, A>::const_iterator
rw_hashmultimap<K, V, Hash, EQ, A>::cend() const
{
    return impl_.cend();
}
...
inline
bool
rw_hashmultimap<K, V, Hash, EQ, A>::empty() const
{
    return impl_.empty();
}
...
inline
bool
rw_hashmultimap<K, V, Hash, EQ, A>::equal_by_keys(const rw_hashmultimap& rhs) const
{
...
template <class K, class V, class Hash, class EQ, class A>
inline
typename rw_hashmultimap<K, V, Hash, EQ, A>::size_type
rw_hashmultimap<K, V, Hash, EQ, A>::size() const
{
    return impl_.size();
}
...
inline
typename rw_hashmultimap<K, V, Hash, EQ, A>::size_type
rw_hashmultimap<K, V, Hash, EQ, A>::count(const key_type& key) const
{
...
inline
typename rw_hashmultimap<K, V, Hash, EQ, A>::const_iterator
rw_hashmultimap<K, V, Hash, EQ, A>::find(const key_type& key) const
{
...
inline
typename rw_hashmultimap<K, V, Hash, EQ, A>::iterator
rw_hashmultimap<K, V, Hash, EQ, A>::find(const key_type& key)
{
    return impl_.find(key);
}
...
inline
typename rw_hashmultimap<K, V, Hash, EQ, A>::iterator
rw_hashmultimap<K, V, Hash, EQ, A>::lower_bound(const key_type& key)
{
    return impl_.find(key);
}
...
inline
typename rw_hashmultimap<K, V, Hash, EQ, A>::const_iterator
rw_hashmultimap<K, V, Hash, EQ, A>::lower_bound(const key_type& key) const
{
    return impl_.find(key);
}
...
inline
typename rw_hashmultimap<K, V, Hash, EQ, A>::iterator
rw_hashmultimap<K, V, Hash, EQ, A>::upper_bound(const key_type& key)
{
...
inline
typename rw_hashmultimap<K, V, Hash, EQ, A>::const_iterator
rw_hashmultimap<K, V, Hash, EQ, A>::upper_bound(const key_type& key) const
{
    return impl_.equal_range(key).second;
}
...
template <class K, class V, class Hash, class EQ, class A>
inline
std::pair<typename rw_hashmultimap<K, V, Hash, EQ, A>::iterator, typename rw_hashmultimap<K, V, Hash, EQ, A>::iterator>
rw_hashmultimap<K, V, Hash, EQ, A>::equal_range(const key_type& key)
{
...
template <class K, class V, class Hash, class EQ, class A>
inline
std::pair<typename rw_hashmultimap<K, V, Hash, EQ, A>::const_iterator, typename rw_hashmultimap<K, V, Hash, EQ, A>::const_iterator>
rw_hashmultimap<K, V, Hash, EQ, A>::equal_range(const key_type& key) const
{
    return impl_.equal_range(key);
}
...
inline
typename rw_hashmultimap<K, V, Hash, EQ, A>::size_type
rw_hashmultimap<K, V, Hash, EQ, A>::capacity() const
{
...
inline
float
rw_hashmultimap<K, V, Hash, EQ, A>::fill_ratio() const
{
...
inline
void
rw_hashmultimap<K, V, Hash, EQ, A>::resize(size_t cap)
{
    impl_.resize(cap);
}
...
inline
void
rw_hashmultimap<K, V, Hash, EQ, A>::swap(rw_hashmultimap& other)
{
...
template <class K, class V, class Hash, class EQ, class A>
inline
std::pair<typename rw_hashmultimap<K, V, Hash, EQ, A>::iterator, bool>
rw_hashmultimap<K, V, Hash, EQ, A>::insert(const value_type& val)
{
...
inline
typename rw_hashmultimap<K, V, Hash, EQ, A>::iterator
rw_hashmultimap<K, V, Hash, EQ, A>::insert(iterator hint, const value_type& val)
{
...
inline
std::pair<typename rw_hashmultimap<K, V, Hash, EQ, A>::iterator, bool>
rw_hashmultimap<K, V, Hash, EQ, A>::insert(value_type && val)
{
...
inline
typename rw_hashmultimap<K, V, Hash, EQ, A>::iterator
rw_hashmultimap<K, V, Hash, EQ, A>::insert(iterator hint, value_type && val)
{
...
inline
typename rw_hashmultimap<K, V, Hash, EQ, A>::size_type
rw_hashmultimap<K, V, Hash, EQ, A>::insert(InputIterator first, InputIterator last)
{
...
inline
typename rw_hashmultimap<K, V, Hash, EQ, A>::size_type
rw_hashmultimap<K, V, Hash, EQ, A>::erase(const key_type& key)
{
...
inline
typename rw_hashmultimap<K, V, Hash, EQ, A>::iterator
rw_hashmultimap<K, V, Hash, EQ, A>::erase(iterator iter)
{
...
inline
typename rw_hashmultimap<K, V, Hash, EQ, A>::iterator
rw_hashmultimap<K, V, Hash, EQ, A>::erase(iterator iter, iterator bound)
{
...
inline
void
rw_hashmultimap<K, V, Hash, EQ, A>::clear()
{
    impl_.clear();
}

/**
 * @relates rw_hashmultimap
 *
 ...
 * rw_hashmultimap::equal_by_keys() instead.
 */
template <class K, class V, class Hash, class EQ, class A>
bool
operator==(const rw_hashmultimap<K, V, Hash, EQ, A>& lhs,
...
#endif /* RW_TOOLS_STDEX_HASHMMAP_H_ */

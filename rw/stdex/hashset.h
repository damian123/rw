#ifndef RW_TOOLS_STDEX_HASHSET_H_
#define RW_TOOLS_STDEX_HASHSET_H_

/**********************************************************************
 *
 * $Id: //tools/13/rw/stdex/hashset.h#10 $
 *
 **********************************************************************
 *
 ...
 *
 * @brief Maintains a collection of some type \c T, in which there cannot be
 * more than one occurrence of some given instance of \c T.
 *
 * Class rw_hashset maintains a collection of \c T, implemented as a hash
 * table in which there may not be more than one instance of any given \c T.
 * Since this is a \e value-based collection, objects are \e copied into and
 * out of the collection. As with all classes that meet the ANSI
 * <i>associative container</i> specification, rw_hashset provides for
 * iterators that reference its elements. Since the contents of rw_hashset
...
public:
     ...
     */
    typedef rw_hashtable<T, Hash, EQ, A, rw_no_duplicates, rw_value_based_key> impl_type;
    ...
    RW_DEPRECATE_TYPE("Use rw_hashset::hasher instead") key_hash_type;
#endif
    ...
    /**
     * Constructs an empty rw_hashset with \a cap buckets, using \a h as the
     ...
     * of buckets is used.
     */
    rw_hashset(size_type cap = RW_DEFAULT_CAPACITY,
               const hasher& h = hasher(),
               const key_equal_type& eq = key_equal_type());

    /**
     * Constructs an rw_hashset containing a copy of the elements in the
     * range [\a first, \a last). The rw_hashset instance has \a cap
    ...
    rw_hashset(InputIterator first,
               InputIterator last,
    ...
    /**
     * Constructs an rw_hashset that is a copy of \a other. Each element
    ...
    /**
     * Move constructor. The constructed rw_hashset takes ownership of the
     ...
     */
    void
    swap(rw_hashset& other);

    /**
     * Inserts a copy of \a val into the container. If an element in the
     * container is equivalent to \a val, an iterator to the existing
     ...
     * equivalent to \a val, an iterator to the existing element in the
     ...
     * the value, the value is not inserted. Returns the number of elements
     * inserted.
     *
     * \c InputIterator is an input iterator type that points to elements
     * that are convertible to #value_type objects.
    ...
    /**
     * Removes the item in the container that compares equal to \a key
...
private:
    ...
    friend bool operator==(const rw_hashset<T1, H1, E1, A1>& lhs,
                           const rw_hashset<T1, H1, E1, A1>& rhs);
...
inline
typename rw_hashset<T, Hash, EQ, A>::key_compare
rw_hashset<T, Hash, EQ, A>::key_comp()
{
    return key_compare();
}
...
template <class T, class Hash, class EQ, class A>
inline
typename rw_hashset<T, Hash, EQ, A>::hasher
rw_hashset<T, Hash, EQ, A>::key_hash() const
{
...
template <class T, class Hash, class EQ, class A>
inline
typename rw_hashset<T, Hash, EQ, A>::key_equal_type
rw_hashset<T, Hash, EQ, A>::key_equal() const
{
    return impl_.key_eq();
}
...
template <typename InputIterator>
inline
rw_hashset<T, Hash, EQ, A>::rw_hashset(InputIterator first, InputIterator last,
...
template <class T, class Hash, class EQ, class A>
inline
rw_hashset<T, Hash, EQ, A>::rw_hashset(size_type cap, const hasher& h,
                                       const key_equal_type& eq)
    : impl_(cap, h, eq)
{
}
...
template <class T, class Hash, class EQ, class A>
inline
rw_hashset<T, Hash, EQ, A>::rw_hashset(const rw_hashset& set)
    : impl_(set.impl_)
{
}
...
template <class T, class Hash, class EQ, class A>
inline
rw_hashset<T, Hash, EQ, A>::rw_hashset(rw_hashset && other)
...
template <class T, class Hash, class EQ, class A>
inline
rw_hashset<T, Hash, EQ, A>::~rw_hashset()
{
}
...
rw_hashset<T, Hash, EQ, A>::operator=(const rw_hashset& rhs)
{
    if (&rhs != this) {
        impl_ = rhs.impl_;
    }
...
inline
rw_hashset<T, Hash, EQ, A>&
rw_hashset<T, Hash, EQ, A>::operator=(rw_hashset && rhs)
{
    if (&rhs != this) {
...
template <class T, class Hash, class EQ, class A>
inline
typename rw_hashset<T, Hash, EQ, A>::iterator
rw_hashset<T, Hash, EQ, A>::begin()
{
    return impl_.begin();
}
...
template <class T, class Hash, class EQ, class A>
inline
typename rw_hashset<T, Hash, EQ, A>::const_iterator
rw_hashset<T, Hash, EQ, A>::begin() const
{
    return impl_.begin();
}
...
inline
typename rw_hashset<T, Hash, EQ, A>::const_iterator
rw_hashset<T, Hash, EQ, A>::cbegin() const
{
    return impl_.cbegin();
}
...
inline
typename rw_hashset<T, Hash, EQ, A>::const_iterator
rw_hashset<T, Hash, EQ, A>::end() const
{
    return impl_.end();
}
...
inline
typename rw_hashset<T, Hash, EQ, A>::const_iterator
rw_hashset<T, Hash, EQ, A>::cend() const
{
    return impl_.cend();
}
...
inline
bool
rw_hashset<T, Hash, EQ, A>::empty() const
{
    return impl_.empty();
}
...
template <class T, class Hash, class EQ, class A>
inline
typename rw_hashset<T, Hash, EQ, A>::size_type
rw_hashset<T, Hash, EQ, A>::size() const
{
    return impl_.size();
}
...
inline
typename rw_hashset<T, Hash, EQ, A>::size_type
rw_hashset<T, Hash, EQ, A>::count(const_reference key) const
{
...
inline
typename rw_hashset<T, Hash, EQ, A>::iterator
rw_hashset<T, Hash, EQ, A>::find(const_reference key) const
{
...
inline
typename rw_hashset<T, Hash, EQ, A>::iterator
rw_hashset<T, Hash, EQ, A>::lower_bound(const_reference key) const
{
    return impl_.find(key);
}
...
inline
typename rw_hashset<T, Hash, EQ, A>::iterator
rw_hashset<T, Hash, EQ, A>::upper_bound(const_reference key) const
{
...
template <class T, class Hash, class EQ, class A>
inline
std::pair < typename rw_hashset<T, Hash, EQ, A>::iterator,
    typename rw_hashset<T, Hash, EQ, A>::iterator >
    rw_hashset<T, Hash, EQ, A>::equal_range(const_reference key) const
{
...
inline
typename rw_hashset<T, Hash, EQ, A>::size_type
rw_hashset<T, Hash, EQ, A>::capacity() const
{
...
inline
float
rw_hashset<T, Hash, EQ, A>::fill_ratio() const
{
...
inline
void
rw_hashset<T, Hash, EQ, A>::resize(size_type sz)
{
    impl_.resize(sz);
}
...
inline
void
rw_hashset<T, Hash, EQ, A>::swap(rw_hashset& other)
{
...
template <class T, class Hash, class EQ, class A>
inline
std::pair<typename rw_hashset<T, Hash, EQ, A>::iterator, bool>
rw_hashset<T, Hash, EQ, A>::insert(const_reference val)
{
...
inline
typename rw_hashset<T, Hash, EQ, A>::iterator
rw_hashset<T, Hash, EQ, A>::insert(iterator hint, const_reference val)
{
...
inline
std::pair<typename rw_hashset<T, Hash, EQ, A>::iterator, bool>
rw_hashset<T, Hash, EQ, A>::insert(value_type && val)
{
...
inline
typename rw_hashset<T, Hash, EQ, A>::iterator
rw_hashset<T, Hash, EQ, A>::insert(iterator hint, value_type && val)
{
...
inline
typename rw_hashset<T, Hash, EQ, A>::size_type
rw_hashset<T, Hash, EQ, A>::insert(InputIterator first, InputIterator last)
{
...
inline
typename rw_hashset<T, Hash, EQ, A>::size_type
rw_hashset<T, Hash, EQ, A>::erase(const_reference key)
{
...
inline
typename rw_hashset<T, Hash, EQ, A>::iterator
rw_hashset<T, Hash, EQ, A>::erase(iterator iter)
{
...
inline
typename rw_hashset<T, Hash, EQ, A>::iterator
rw_hashset<T, Hash, EQ, A>::erase(iterator first, iterator last)
{
...
inline
bool
operator==(const rw_hashset<T, Hash, EQ, A>& lhs,
           const rw_hashset<T, Hash, EQ, A>& rhs)
{
...
#endif /* RW_TOOLS_STDEX_HASHSET_H_ */
